...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("tardling.ttf"), 32, 0xFFEBE7AD, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("tardling.ttf"), 20, 0xFFEBE7AD, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("vcr.ttf"), 32, 0xFFEBE7AD, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
