...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("tardling.ttf"), 32, 0xFFEBE7AD, CENTER, FlxTextBorderStyle.OUTLINE, 0xFF253b46);
		...
		scoreTxt.setFormat(Paths.font("tardling.ttf"), 20, 0xFFEBE7AD, CENTER, FlxTextBorderStyle.OUTLINE, 0xFF253b46);
		...
		botplayTxt.setFormat(Paths.font("vcr.ttf"), 32, 0xFFEBE7AD, CENTER, FlxTextBorderStyle.OUTLINE, 0xFF253b46);
